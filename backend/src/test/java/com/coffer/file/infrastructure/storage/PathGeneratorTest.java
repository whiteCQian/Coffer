...
class PathGeneratorTest {
    ...
    void generateArchivePathUsesCategorySlugDateAndSequence() {
        ...
        assertThat(path).isEqualTo("contracts/2025/08/29/000-销售合同.pdf");
    }
    ...
    void nullCategoryArchivesToUncategorized() {
        ...
        assertThat(path).startsWith("uncategorized/2025/01/01/");
    }
    ...
    void noExtensionKeepsSanitizedNameAfterSequence() {
        ...
        String fileName = path.substring("reports/2025/06/15/".length());
    ...
    void nullUploadTimeUsesNow() {
        ...
        assertThat(path).startsWith("invoices/");
    ...
    void illegalCharsInExtensionSanitized() {
        ...
        String fileName = path.substring("images/2025/05/05/".length());
    ...
    void sequenceUsesThreeUppercaseHexDigits() {
        ...
        assertThat(path).isEqualTo("contracts/2026/09/21/0AF-采购合同.txt");
    }
}
