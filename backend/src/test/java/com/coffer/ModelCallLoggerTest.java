...
class ModelCallLoggerTest extends com.coffer.auth.OwnerTestSupport {
    ...
    void aspectInterceptsAndPersists() throws Exception {
        ...
        for (int i = 0; i < 30; i++) {
            List<ModelCallLog> rows = repository.findAll().stream()
        ...
        assertThat(saved.getUserMessage()).isNull();
